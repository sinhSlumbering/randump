...
let canSpy (knightIsAwake: bool) (archerIsAwake: bool) (prisonerIsAwake: bool): bool = knightIsAwake || archerIsAwake || prisonerIsAwake
...
let canFreePrisoner (knightIsAwake: bool) (archerIsAwake: bool) (prisonerIsAwake: bool) (petDogIsPresent: bool): bool =
    (petDogIsPresent && not archerIsAwake) || (not petDogIsPresent && prisonerIsAwake && not (archerIsAwake || knightIsAwake))
